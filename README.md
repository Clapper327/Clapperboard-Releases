...
[Windows 3.68 다운로드](https://github.com/Clapper327/Clapperboard-Releases/releases/tag/v3.68) · [macOS 3.62 다운로드](https://github.com/Clapper327/Clapperboard-Releases/releases/tag/v3.62)
...
Windows는 3.68, macOS는 3.62입니다. macOS 3.68은 다음 릴리스에서 제공됩니다.
...
- Premiere XML, CapCut draft, Final Cut Pro XML 내보내기 흐름을 다시 검증했습니다.

### macOS 3.62 (유지)

- macOS는 현재 3.62이며 24트랙, Synking, 전체 트랙 재생, Premiere/CapCut/Final Cut 내보내기와 실행 버튼 옆 업데이트 버튼을 포함합니다. macOS 3.68은 다음 릴리스에서 제공됩니다.
